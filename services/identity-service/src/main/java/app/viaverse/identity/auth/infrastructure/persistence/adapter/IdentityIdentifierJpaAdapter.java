package app.viaverse.identity.auth.infrastructure.persistence.adapter;
...
import app.viaverse.identity.auth.infrastructure.persistence.mapper.IdentityIdentifierJpaMapper;
