package app.viaverse.identity.consent.infrastructure.persistence.adapter;

import app.viaverse.identity.consent.application.port.out.ConsentRecordRepository;
import app.viaverse.identity.consent.infrastructure.persistence.mapper.ConsentRecordJpaMapper;
