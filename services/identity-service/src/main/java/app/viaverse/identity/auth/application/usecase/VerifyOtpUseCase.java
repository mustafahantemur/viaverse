...
public class VerifyOtpUseCase {
    ...
    public VerifyOtpResponse verify(UUID flowId, String otp, String userAgent, String clientIp) {
        ...
        if (flow.getAccountId() == null) {
            ActionLogContext.put("auth.next_step", "registration_required");
        ...
        IdentityAuditEvents.recordAccountSecurityEvent(auditLogger, account.getId(), IdentityAuditEvent.LOGIN_SUCCEEDED);
        ActionLogContext.put("auth.next_step", "authenticated");
