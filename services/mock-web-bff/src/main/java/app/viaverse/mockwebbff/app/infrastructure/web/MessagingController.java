...
import app.viaverse.mockwebbff.app.MockMessagingService;
...
public class MessagingController {
    ...
    private final MockMessagingService service;

    public MessagingController(MockMessagingService service) {
