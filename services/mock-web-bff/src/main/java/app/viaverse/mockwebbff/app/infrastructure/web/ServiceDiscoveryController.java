...
import app.viaverse.mockwebbff.app.MockServiceDiscoveryService;
...
public class ServiceDiscoveryController {
    ...
    private final MockServiceDiscoveryService service;

    public ServiceDiscoveryController(MockServiceDiscoveryService service) {
