...
/**
 * Generic outbox row used by every event-emitting service. The table name
 * {@code outbox_event} is intentionally service-agnostic — each service
 * owns its own physical table by virtue of running its own database, so
