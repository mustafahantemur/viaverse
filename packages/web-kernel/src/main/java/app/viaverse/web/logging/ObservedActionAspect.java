package app.viaverse.web.logging;
...
public final class ObservedActionAspect {
    ...
    public Object observe(ProceedingJoinPoint joinPoint, ObservedAction observedAction) throws Throwable {
        ...
        try {
            ...
            log(observedAction.value(), "failure", exception.errorCode(), startedAt, exception, span);
            throw exception;
    ...
    private void log(
        ...
        if (throwable instanceof RetryAfterAware retryAfterAware) {
            builder.addKeyValue("retry_after_seconds", retryAfterAware.retryAfterSeconds());
        }
