  ...
  return (
    <section style={{
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        {/* Reversed (silver/green) V — sits to the left of the image */}
        <img src="../../assets/viaverse_icon_silver_green.png" alt="Viaverse"
          style={{
            position: "absolute", left: -100, bottom: -36,
            width: 130, height: 130, objectFit: "contain",
            filter: "drop-shadow(0 24px 36px rgba(0,0,0,0.55)) drop-shadow(0 8px 14px rgba(0,0,0,0.4))",
          }}/>
      </div>
    </section>
  );
